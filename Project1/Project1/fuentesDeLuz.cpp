...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Fuentes de luz Uriel Agustin", nullptr, nullptr);
	...
	Model Dog((char*)"Models/Low-Poly Plant_.obj");
